...
OPENAI_BASE_URL = _env("OPENAI_BASE_URL", "https://byesu.com/v1")
OPENAI_WIRE_API = _env("OPENAI_WIRE_API", "responses")
OPENAI_REASONING_EFFORT = _env("OPENAI_REASONING_EFFORT", "medium")
DISABLE_RESPONSE_STORAGE = _bool_env("DISABLE_RESPONSE_STORAGE", True)
...
WATCHDOG_INTERVAL_SECONDS = _float_env("WATCHDOG_INTERVAL_SECONDS", 600.0)
